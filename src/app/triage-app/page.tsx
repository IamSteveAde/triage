        ...
        <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div initial={{ opacity: 0, y: 60 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              ...
              <button className="px-8 py-4 rounded-full bg-triage-orange hover:bg-[#8c5c27] text-white flex items-center gap-2 transition">
          ...
          {/* APP MOCK */}
          <motion.div initial={{ opacity: 0, scale: 0.95, y: 40 }} animate={{ opacity: 1, scale: 1, y: 0 }} className="flex justify-center lg:justify-end">
